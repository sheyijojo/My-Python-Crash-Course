...
# storing your functions in a seperate file called a module
# a module can be imported in your program. Storing ur prog in a sepearate file makes
# u focus onn the higherlevel logic and hide details of ur prog code.

print('\n')
print(f"-" * 20)
# 
print("Importing an entire module")
# to start importing functions, we ist need to create a module.
